		...
		if (this.state.hasError) {
			...
			return (
				<div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
					<div className="max-w-md w-full bg-slate-800 rounded-xl p-8 border border-red-500/30">
						{/* Error Icon */}
						...
						<div className="flex flex-col gap-3">
							<button
								...
								className="flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors font-semibold"
							>
								<RefreshCw size={18} />
							...
							<a
								href="/"
								className="text-center text-slate-400 hover:text-white transition-colors text-sm"
							>
								Go back to home
							</a>
						</div>
