...
// Parse the Demon Slayer - Gurenge MIDI file
const midiPath = path.join(__dirname, '../src/assets/midi/Demon Slayer - Gurenge.mid');
...
const outputPath = path.join(__dirname, '../src/assets/midi/parsed-gurenge.json');
...
console.log(`\nprivate readonly gurengeBass = [${backgroundFrequencies.join(', ')}];`);
console.log(`\nprivate readonly gurengeMelody = [${melodyFrequencies.join(', ')}];`);
