...
// Parse the River Flows In You MIDI file
const midiPath = path.join(__dirname, '../src/assets/midi/YIRUMA - River Flows In You.mid');
...
const outputPath = path.join(__dirname, '../src/assets/midi/parsed-river-flows.json');
...
console.log(`\nprivate readonly riverFlowsBass = [${backgroundFrequencies.join(', ')}];`);
console.log(`\nprivate readonly riverFlowsMelody = [${melodyFrequencies.join(', ')}];`);
